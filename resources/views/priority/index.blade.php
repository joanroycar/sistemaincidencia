...
<div class="middle-content container-xxl p-0">
    ...
    <div class="page-meta">
        ...
        <a href="{{route('priorities.create')}}" class="btn btn-xm btn-primary"  style="float: right;">Crear Prioridad</a>
          {{-- </div> --}}
        <nav class="breadcrumb-style-one" aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="#">Tabla</a></li>
                <li class="breadcrumb-item active" aria-current="page">Prioridad</li>
            </ol>
        </nav>
                        ...
                        <tr>
                            <td>
                                <div class="d-flex">                                                        
                                    ...
                                    <p class="align-self-center mb-0 admin-name"> {{$priority->id}} </p>
                                </div>
                            </td>
                            <td>{{$priority->name}}</td>
