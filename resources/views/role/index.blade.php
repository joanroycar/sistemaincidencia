...
<div class="middle-content container-xxl p-0">
    ...
    <div class="page-meta">
        ...
        <a href="{{url('/role/create')}}" class="btn btn-xm btn-primary"  style="float: right;">Crear Nuevo Rol</a>
          {{-- </div> --}}
                        ...
                        <tr>
                            <td>
                                <div class="d-flex">                                                        
                                    ...
                                    <p class="align-self-center mb-0 admin-name"> {{$role->id}} </p>
                                </div>
                            </td>
                            <td>{{$role->name}}</td>
