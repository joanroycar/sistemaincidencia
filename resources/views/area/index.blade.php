...
<div class="middle-content container-xxl p-0">
    ...
    <div class="page-meta">
        ...
        <a href="{{route('areas.create')}}" class="btn btn-xm btn-primary"  style="float: right;">Crear Area</a>
          {{-- </div> --}}
                        ...
                        <tr>
                            <td>
                                <div class="d-flex">                                                        
                                    ...
                                    <p class="align-self-center mb-0 admin-name"> {{$area->id}} </p>
                                </div>
                            </td>
                            <td>{{$area->name}}</td>
