...
<div class="page-header">
                ...
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        <div class="text-xm font-weight-bold text-uppercase mb-1" style="color: #4C5755">
                            Total de Incidentes:</div>
                        <div class="h3 mb-0 font-weight-bold text-gray-800"> {{$totalincidences}}</div>
                    </div>
                    <div class="col-auto">
    ...
    <div class="col-xl-4 col-md-6 mb-4">
      <div class="card border-left-primary shadow h-100 py-2" style="border-left: 0.25rem solid #bd0003!important">
          <div class="card-body">
              <div class="row no-gutters align-items-center">
                  <div class="col mr-2">
                      <div class="text-xm font-weight-bold text-uppercase mb-1" style="color: #4C5755">
                          Incidentes Cerrados:</div>
                      <div class="h3 mb-0 font-weight-bold text-gray-800">{{$totalstatus}}</div>
                  </div>
                  <div class="col-auto">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-eye"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path><circle cx="12" cy="12" r="3"></circle></svg>
    ...
    <div class="col-xl-4 col-md-6 mb-4">
      <div class="card border-left-primary shadow h-100 py-2" style="border-left: 0.25rem solid #2897f4!important">
          <div class="card-body">
              <div class="row no-gutters align-items-center">
                  <div class="col mr-2">
                      <div class="text-xm font-weight-bold text-uppercase mb-1" style="color: #4C5755">
                        Incidentes Abiertos:</div>
                      <div class="h3 mb-0 font-weight-bold text-gray-800">{{$totalstatusopen}} </div>
                  </div>
                  <div class="col-auto">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-eye"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path><circle cx="12" cy="12" r="3"></circle></svg>
  ...
  <div class="col-xl-8 col-lg-7">
    <div class="card shadow mb-4">
        <div
            ...
            <h6 class="m-0 font-weight-bold" style="color: #4C5755">Total De Incidentes Por Mes</h6>
...
<div class="col-xl-4 col-lg-5">
  <div class="card shadow mb-4">
      <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
          <h6 class="m-0 font-weight-bold" style="color: #4C5755">Incidentes Por Categoria:</h6>
