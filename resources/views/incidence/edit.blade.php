...
<div class="container">
    ...
    <h4 class="mt-5">Editar Incidencia</h4>
    

    {!! Form::model($incidence, ['route' => ['incidences.update', $incidence], 'method' => 'put','files'=>true, 'class'=>'formulario row g-3']) !!}
    <div class="col-md-12">
        <label for="asunto" class="form-label">Asunto:</label>
        <input type="name" class="form-control" id="asunto" name="asunto" style="color: white" value="{{$incidence->asunto}}">
        @error('asunto')
    ...
    <div class="col-md-6">
        <label for="name" class="form-label">Categoria:  <small style="color: red"> Si en caso va realizar una modificación utilizar esta opción.  </small> </label>
    ...
    <div class="col-md-6">
        <label for="name" class="form-label">SubCategoria: <small style="color: red"> Categoria de Incidente Actual:   <b>{{$incidence->subcategories->categories->name}} </b>  </small> </label>
    ...
    <div class="col-md-12">
        ...
        <textarea class="form-control" id="observation" name="observation" rows="3" value="{{old('observation')}}">{{$incidence->observation}} </textarea>
